...
export function Add_Absend() {
  ...
  React.useEffect(() => {
    ...
    if(location.state !== null){
        ...
        dispatch(GetEmpByCode(location.state.id));
        setSearchState(1)
    }
                        ...
                        <div id="content">
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="col-lg-12 form-group">
                                    ...
                                    <hr/>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">วันที่เริ่มลา :</label>
                                        <div class="col-lg-2">
                                          {dep === 15 ?
                                          <input type="date" 
                                                class="form-control" 
                                        ...
                                        <label class="col-lg-2 col-form-label">วันสิ้นสุด :</label>
                                        <div class="col-lg-2">
                                          <input type="date" 
                                                class="form-control" 
                                                name="search" 
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">วันที่มาทำงาน :</label>
                                        <div class="col-lg-2">
                                          <input type="date" 
                                                class="form-control" 
                                                name="search" 
                                        ...
                                        <label class="col-lg-2 col-form-label">จำนวนวัน :</label>
                                        <div class="col-lg-2">
                                          <input type="number" 
                                                class="form-control" 
                                                name="search" 
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">ประเภทการลา :</label>
                                        <div class="col-lg-2">
                                          {dep === '15' ?
                                          <Select 
                                          ...
                                          <Select 
                                                ...
                                                labelKey='prefix'
                                                valueKey='id'
                                                options={absend_type.filter(obj=>obj.gen === emp.gender || obj.gen === 3)}
                                                menuPlacement="auto"
                                                menuPosition="fixed" 
                                                selectedOption={absend.absend_type_id}                
                                            /> 
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">สาเหตุ :</label>
                                        <div class="col-lg-5">
                                          <textarea 
                                                class="form-control" 
                                                name="search" 
                                        ...
                                        <div class="col-lg-3">  
                                            <button className='btn btn-primary' onClick={saveAbsend} loading={showLoader} disabled={showLoader}>
